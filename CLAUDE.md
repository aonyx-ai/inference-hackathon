...
We are participating in Whale's Inference Hackathon, during which we are quickly
building a demo of a better interface for scoping agentic work.
...
- Always draft the commit message and wait for approval before committing.
